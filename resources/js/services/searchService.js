    ...
    getSearchCategories() {
        return [
            ...
            },
            {
                ...
                label: "Faculty & Staff",
                icon: "👥",
                description: "Teachers and school personnel",
                color: "bg-purple-500",
            },
            {
                type: "programs",
                ...
                icon: "🎓",
                description: "Database academic programs",
                color: "bg-indigo-500",
            },
            {
                type: "academics",
            ...
            },
            {
                ...
                label: "Awards",
                icon: "🏆",
                description: "Principal and school awards",
                color: "bg-orange-500",
            },
            {
                type: "resources",
                label: "Resources",
                icon: "📚",
                description: "Downloads and documents",
                color: "bg-red-500",
            },
            {
                type: "links",
