...
class AnnouncementSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $announcements = [
            ...
            [
                'title' => 'Basketball Team Tryouts Begin Next Week',
                'content' => 'Interested students are invited to join the basketball team tryouts. All skill levels are welcome to participate.',
            ...
            [
                'title' => 'Volleyball Championship Tournament',
                'content' => 'Annual volleyball championship tournament will be held this month. Come support our school teams!',
                'author' => 'Sports Department',
                'category' => 'Sports',
                'status' => 'published',
